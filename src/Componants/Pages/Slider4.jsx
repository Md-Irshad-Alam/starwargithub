...
function Slider4() {
  ...
  return (
    <>
    <div className="title-bodys4  w-85 m-auto mt-7 pl-5 pr-5 mb-1.5 ">
        ...
        <div className='slider3-wrap flex items-center justify-center  absolut '>
